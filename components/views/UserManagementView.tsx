...
import { useUsersQuery } from "@/app/[locale]/(dashboard)/user-management/hooks/useUsersQuery";
import { useCreateUser, useUpdateUser, useDeleteUser } from "@/app/[locale]/(dashboard)/user-management/hooks/useUserMutations";
...
import { UserToolbar } from "@/app/[locale]/(dashboard)/user-management/_components/UsersTab/UsersToolbar";
import { UserTable } from "@/app/[locale]/(dashboard)/user-management/_components/UsersTab/UsersTable";
import { UserPagination } from "@/app/[locale]/(dashboard)/user-management/_components/UsersTab/UsersPagination";
import { EditUserDrawer } from "@/app/[locale]/(dashboard)/user-management/_components/UsersTab/EditUserDrawer";
import {
  AddUserModal,
  DeleteConfirmModal,
} from "@/app/[locale]/(dashboard)/user-management/_components/UsersTab/UserModals";
import type { UserFormValues } from "@/app/[locale]/(dashboard)/user-management/_components/UsersTab/UserModals";
import { PermissionsTab } from "@/app/[locale]/(dashboard)/user-management/_components/PermissionsTab/PermissionsTab";
import {
  AddDepartmentModal,
  EditDepartmentModal,
  DeleteDepartmentModal,
} from "@/app/[locale]/(dashboard)/user-management/_components/PermissionsTab/DepartmentModals";
import type { TenantFormValues } from "@/app/[locale]/(dashboard)/user-management/_components/PermissionsTab/DepartmentModals";
import { useTenantsQuery } from "@/app/[locale]/(dashboard)/user-management/hooks/useTenantsQuery";
import {
  useCreateTenant,
  useUpdateTenant,
  useDeleteTenant,
} from "@/app/[locale]/(dashboard)/user-management/hooks/useTenantMutations";
import type { TenantCreateRequest, TenantUpdateRequest } from "@/services/tenant/types";
import {
  AddRoleModal,
  EditRoleModal,
  DeleteRoleModal,
} from "@/app/[locale]/(dashboard)/user-management/_components/RolesTab/RolesModals";
import type { RoleFormValues } from "@/app/[locale]/(dashboard)/user-management/_components/RolesTab/RolesModals";
import { useTenantRolesQuery } from "@/app/[locale]/(dashboard)/user-management/hooks/useTenantRolesQuery";
import {
  useCreateTenantRole,
  useUpdateTenantRole,
  useDeleteTenantRole,
} from "@/app/[locale]/(dashboard)/user-management/hooks/useTenantRoleMutations";
import type { TenantRoleCreateRequest, TenantRoleUpdateRequest } from "@/services/tenant-role/types";
import { useTenantPermissionsQuery } from "@/app/[locale]/(dashboard)/user-management/hooks/useTenantPermissionsQuery";
import {
  useAssignPermissions,
  useDeassignPermissions,
} from "@/app/[locale]/(dashboard)/user-management/hooks/useTenantPermissionMutations";
