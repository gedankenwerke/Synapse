...
import { useNetBalanceQuery } from "@/app/[locale]/(dashboard)/net-balance/hooks/useNetBalanceQuery";
import { formatBaht, formatCompact, formatDate, formatLastUpdated } from "@/app/[locale]/(dashboard)/net-balance/_components/utils";
...
export function NetBalanceView() {
