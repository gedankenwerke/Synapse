...
import { TransactionToolbar } from "../deposits-withdrawals/_components/TransactionTab/TransactionToolbar";
import { TransactionTable } from "../deposits-withdrawals/_components/TransactionTab/TransactionTable";
import { TransactionDetailModal } from "../deposits-withdrawals/_components/TransactionTab/TransactionModals";
import { useTransactionQuery } from "../deposits-withdrawals/hooks/useTransactionQuery";
  ...
  if (isLoading && items.length === 0) {
    return (
      <Container size="xl" py="md">
        <Text fz="xl" fw={700} mb="md">{t("listTitle")}</Text>
